...
import type { ExternalBlob as _ExternalBlob, Presentation as _Presentation, Time as _Time, UserRole as _UserRole, ViewRequest as _ViewRequest, ViewRequestStatus as _ViewRequestStatus, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async approveRequest(arg0: string): Promise<ViewRequest> {
        if (this.processError) {
            try {
                const result = await this.actor.approveRequest(arg0);
                return from_candid_ViewRequest_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async generateQrCodeUrl(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.generateQrCodeUrl(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPresentations(): Promise<Array<Presentation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPresentations();
    ...
    async getAllRequests(): Promise<Array<ViewRequest>> {
        if (this.processError) {
            try {
    ...
    async getApprovedPresentation(arg0: string): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.getApprovedPresentation(arg0);
    ...
    async getPresentation(arg0: string): Promise<Presentation> {
        if (this.processError) {
            try {
                const result = await this.actor.getPresentation(arg0);
                return from_candid_Presentation_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getRequest(arg0: string): Promise<ViewRequest> {
        if (this.processError) {
            try {
    ...
    async rejectRequest(arg0: string): Promise<ViewRequest> {
        if (this.processError) {
            try {
    ...
    async submitViewRequest(arg0: string, arg1: string, arg2: string): Promise<ViewRequest> {
        if (this.processError) {
            try {
                const result = await this.actor.submitViewRequest(arg0, arg1, arg2);
                return from_candid_ViewRequest_n8(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadPresentation(arg0: string, arg1: string, arg2: ExternalBlob): Promise<Presentation> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadPresentation(arg0, arg1, await to_candid_ExternalBlob_n21(this._uploadFile, this._downloadFile, arg2));
                return from_candid_Presentation_n15(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Presentation_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Presentation): Promise<Presentation> {
...
function from_candid_ViewRequestStatus_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ViewRequestStatus): ViewRequestStatus {
    return from_candid_variant_n11(_uploadFile, _downloadFile, value);
}
function from_candid_ViewRequest_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ViewRequest): ViewRequest {
...
function from_candid_record_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        status: from_candid_ViewRequestStatus_n10(_uploadFile, _downloadFile, value.status),
...
function from_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "pending" in value ? ViewRequestStatus.pending : "approved" in value ? ViewRequestStatus.approved : "rejected" in value ? ViewRequestStatus.rejected : value;
}
...
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Presentation>): Promise<Array<Presentation>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Presentation_n15(_uploadFile, _downloadFile, x)));
}
function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ViewRequest>): Array<ViewRequest> {
    return value.map((x)=>from_candid_ViewRequest_n8(_uploadFile, _downloadFile, x));
}
